...
$app->post("/checkout", function(){
	...
	$order->save();
	header("Location: /Projeto-PHP7-Hcode/index.php/order/".$order->getidorder());
	exit;
});
...
$app->post('/forgot', function(){
	...
	header('Location: /Projeto-PHP7-Hcode/index.php/forgot/sent');
	exit;
});
...
$app->get("/boleto/:idorder",function($idorder){
	...
	// NÃO ALTERAR!
	$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "Projeto-PHP7-Hcode" . DIRECTORY_SEPARATOR . "res" . DIRECTORY_SEPARATOR . "boletophp" . DIRECTORY_SEPARATOR . "include" . DIRECTORY_SEPARATOR;
...
$app->post('/profile/change-password', function(){
	...
	if (!isset($_POST['current_pass']) || $_POST['current_pass'] === '') {
		...
		Header("Location: /Projeto-PHP7-Hcode/index.php/profile/profile-change-password");
		exit;
	}
