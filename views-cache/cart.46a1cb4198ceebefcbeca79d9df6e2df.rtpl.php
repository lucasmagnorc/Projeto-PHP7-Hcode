      ...
      <div class="col-md-12">
        <div class="product-content-right">
          <div class="woocommerce">
            ...
            <form action="/Projeto-PHP7-Hcode/index.php/checkout">
              <?php if( $error != '' ){ ?>
                ...
                <tbody>
                  ...
                  <tr class="cart_item">
                    <td class="product-remove">
                      <a title="Remove this item" class="remove" href="/Projeto-PHP7-Hcode/index.php/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">×</a> 
                    </td>
                    ...
                    <td class="product-quantity">
                      <div class="quantity buttons_added">
                        <input type="button" class="minus" value="-" onclick="window.location.href = '/Projeto-PHP7-Hcode/index.php/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/minus'">
                        ...
                        <input type="button" class="plus" value="+" onclick="window.location.href = '/Projeto-PHP7-Hcode/index.php/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add'">
                      </div>
                    </td>
              ...
              <div class="cart-collaterals">
                ...
                <div class="cross-sells">
                  ...
                  <div class="coupon">
                    ...
                    <input type="submit" formmethod="post" formaction="/Projeto-PHP7-Hcode/index.php/cart/freight" value="CÁLCULAR" class="button">
                  </div>
